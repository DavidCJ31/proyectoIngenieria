...
<body>
    ...
    <!--Main Navigation-->
    <form method="post" action="" id="formPrimerSeguimiento">
        @csrf
        @method('PUT')
        ...
        <div class="form-card">
            ...
            <div class="input-group mb-3">
                ...
                <select class="form-control" name="nombre-curso" id="nombre-curso" form="formInformacionDetallada" aria-describedby="basic-addon2" style="margin-right: 15px;">
            ...
            <div class="input-group mb-3">
                <div class="input-group-append">
                    <button type="button" class="btn btn-primary" id="boton-enviar">Enviar</button>
                </div>
            </div>
        </div>
    </form>
