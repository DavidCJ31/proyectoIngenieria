...
<body>
  ...
  <div class="form-card">
    <h6 class="text-center">VICERRECTORÍA DE VIDA ESTUDIANTIL</h6>
    <H6 class="text-center text-uppercase">DEPARTAMNETO DE ORIENTACIÓN Y PSICOLOGÍA</H6>
    ...
    <form method="post" action="/referencia" id="referencia">
    @csrf
      ...
      <div class="input-group mb-3">
        <div class="input-group-append">
          <span class="input-group-text "><strong style="color:red;">*</strong>Nombre del estudiante:  </span> 
        </div>
        <input type="text" alt="Nombre Completo" class="form-control"  id="nombre-estudiante" name="nombre-estudiante" aria-describedby="basic-addon2" required>
      </div>
      ...
      <div class="input-group mb-3">
        ...
        <input type="text" class="form-control" maxlength="9" id="cedula" name="cedula" aria-describedby="basic-addon2" required>

        <div class="input-group-append">
          <span class="input-group-text">Edad: </span>
        </div>
        <input type="number" class="form-control" id="edad" aria-describedby="basic-addon2">
      </div>
      ...
      <div class="input-group mb-3">
        ...
        <input type="number" class="form-control" name="teluno" id="telefono1" aria-describedby="basic-addon2">

        <div class="input-group-append">
          <span class="input-group-text">Teléfono 2: </span>
        </div>
        <input type="number" class="form-control" name="teldos" id="telefono2" aria-describedby="basic-addon2">
      </div>
      ...
      <div class="input-group mb-3">
        ...
        <input type="email" class="form-control" name="email" id="correo" aria-describedby="basic-addon2">
      </div>
      ...
      <div class="input-group mb-3">
        ...
        <input type="number" class="form-control" min="1976" id="ano-ingreso" aria-describedby="basic-addon2" value="1976" required>
      </div>
      ...
      <div class="input-group mb-3">
        <div class="input-group-append">
          <button type="submit" class="btn btn-primary" id="boton-enviar">Enviar informe</button>
        </div>
      </div>
    </form>
  </div>
