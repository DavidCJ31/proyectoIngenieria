...
<!--Main Navigation-->
<!--Main Navigation-->
<!--<form method="post" action="/SeguimientoIndividual" id="formSeguimientoIndividual"> -->
        @csrf
    ...
    <div class= "form-card">
        <h4 class="text-center">VICERRECTORIA DE DOCENCIA</h4><H5 class="text-center" >EXITO ACADEMICO</H5><h4 class="text-center">SOLICITUD DE TUTORIA</h4>
          ...
          <div class="input-group mb-3">
            ...
            <input type="date" class="form-control" id="campo-fecha" name="campo-fecha" aria-describedby="basic-addon2" style="width: 50%;">
          </div>
          ...
          <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" id="campo-nombre" name="campo-nombre" aria-describedby="basic-addon2">
          </div>
          ...
          <textarea class="form-control" id="campo-acuerdos" name="campo-acuerdos" rows="3"></textarea>

          <button onclick="enviarDatos()"  id="boton-enviar">Enviar solicitud</button>
