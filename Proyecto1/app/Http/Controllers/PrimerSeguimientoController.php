...
class PrimerSeguimientoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/PrimerSeguimiento');
    }
    ...
    {
        $estudiante = estudiante::find($id)->user;
        $estudiantePrimerSeguimiento = estudiante_Primer_Seguimiento::where('estudiante_id', $id)->first();
        return view('')->with('estudiante', $estudiante)->with('estudiantePrimerSeguimiento', $estudiantePrimerSeguimiento);
    }
    ...
    {
        estudiante_Primer_Seguimiento::where('estudiante_id', $id)
        ->update([
